# Plone Brasil (@plonegovbr/site)

Site da comunidade brasileira de Plone

[![npm](https://img.shields.io/npm/v/@plonegovbr/site)](https://www.npmjs.com/package/@plonegovbr/site)
[![](https://img.shields.io/badge/-Storybook-ff4785?logo=Storybook&logoColor=white&style=flat-square)](https://plonegovbr.github.io/site/)
...
Add `@plonegovbr/site` to your `package.json`.
...
Add `@plonegovbr/site` to your `volto.config.js`.
...
yo @plone/volto my-volto-project --addon @plonegovbr/site
cd my-volto-project
```
